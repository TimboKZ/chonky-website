...
Note that in both cases, you should be careful with the action payload. If you don't
provide a null payload to an action that expects non-null payload, Chonky might throw an
error
