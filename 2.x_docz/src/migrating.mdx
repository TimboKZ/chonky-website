...
-   ⚠️ Explicit TypeScript types for component props are no longer exported. This change
    will likely be reverted before 2.x release.
...
-   ⚠️ The signature (type) of the file action handler has changed completely, and the
    new signature not backwards-compatible. File action handler was changed to be
    more future proof and type-safe.
