...
The `files` prop should be an array that can contain file descriptions or nulls. File
...
you're good. If you don't know what immutability is, please read the _Immutability_
section from the sidebar. This is important.

You can see the formal type for the `files` prop below. Chonky exports this type for
