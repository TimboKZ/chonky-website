...
You can enable built-in file actions by
...
file actions and "other" file actions.
...
[src-other]: https://github.com/TimboKZ/Chonky/blob/2.x/packages/chonky/src/action-definitions/other.ts
